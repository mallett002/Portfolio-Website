            ...
            <nav className='nav-wide' style={{
                ...
                <ul>
                    ...
                    <div className='contact'>
                        <a target="_blank" href="https://github.com/mallett002" className='social-a'>
                            <img className='social-img' src={git}/>
                        </a>
                        <a target="_blank" href="https://linkedin.com/in/mallettwilliam" className='social-a'>
                            <img className='social-img' src={link}/>
                        </a>
                    </div>
                </ul>
            </nav>
